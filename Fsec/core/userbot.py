...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("indian_hacker_group")
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("Indian_hacker_group")
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("indian_hacker_group")
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("Indian_hacker_group")
