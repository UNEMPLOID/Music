...
from Fsec import app, userbot
from Fsec.misc import SUDOERS
from Fsec.utils.database import (get_active_chats,
                                       ...
                                       update_user_top)
from Fsec.utils.decorators.language import language
from Fsec.utils.formatters import alpha_to_int
...
async def braodcast_message(client, message, _):
    ...
    if "-assistant" in message.text:
        ...
        text = _["broad_3"]
        from Fsec.core.userbot import assistants
