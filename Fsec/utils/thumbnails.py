...
async def gen_thumb(videoid, chat_id):
    ...
    try:
        ...
        bg = Image.open(f"Fsec/assets/bg.png")
        ...
        font = ImageFont.truetype("Fsec/assets/font2.ttf", 45)
        ImageFont.truetype("Fsec/assets/font2.ttf", 70)
        arial = ImageFont.truetype("Fsec/assets/font2.ttf", 30)
        ImageFont.truetype("Fsec/assets/font.ttf", 30)
